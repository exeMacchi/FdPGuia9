/*
    3. Una empresa de transporte de carga por camión posee 20 tarifas distintas 
       de acuerdo al destino de los envíos que deba realizar. Dispone de un lote
       de registros con la siguiente información:
          - Número de Tarifa(Número de 4 cifras, no correlativos).
          - Importe por KM.
       Este lote no viene ordenado. A continuación, dispone de un segundo lote 
       de registros con la información de los envíos que se realizaron durante 
       ...
       Se nos pide realizar un programa que determine e informe:
          ...
          b) Un listado como el siguiente:
             ...
             de mayor a menor.
          c) Indicar el número de camión que recorrió la menor cantidad de 
             kilómetros entre los que realizaron viajes.
