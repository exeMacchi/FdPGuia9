// 2. Se dispone de un lote de 300 registros (uno por artículo), cada uno de los cuales tiene la siguiente información:
//       - Número de artículo (4 dígitos no correlativos).
//       - Cantidad de unidades en stock.
//       - Precio Unitario.
//    El lote está desordenado. Se dispone de otro lote de registros, cada uno de los cuales corresponde a una venta 
//    con la siguiente información:
//       - Número de cliente (1 a 300).
//       - Número de artículo (4 dígitos, no correlativos).
//       - Cantidad de unidades vendidas.
//    El último registro de este lote tiene número de cliente cero y no debe procesarse.
//    
