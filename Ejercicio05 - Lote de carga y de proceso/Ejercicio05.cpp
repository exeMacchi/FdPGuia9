// 5. Una empresa de alquiler de autos cuenta con distintas agencias desde donde efectúa sus operaciones. 
//    Para ello cuenta con varios lotes de registros. Un primer lote contiene los datos de los autos, 
...
//    Este lote se encuentra ordenado por código de auto y contiene 400 registros. Existe un segundo lote con 
//    la información de los alquileres que se realizaron durante el mes pasado. Cada registro contiene:
//       - Código de auto (4 dígitos no correlativos).
...
//          alquileres en total. Para calcular el importe del alquiler de un auto se debe multiplicar 
//          el importe en pesos por kilómetro por la cantidad de kilómetros recorridos.
...
int main()
{
    ...
    Proceso(vAutos, vClientes, cantAutos, vUbicaciones, vCategorias, vAgenciasMensual, alquiler);
